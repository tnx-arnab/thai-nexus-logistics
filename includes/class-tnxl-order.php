...
class TNXL_Order {
    ...
    public function queue_shipment_creation($order_id) {
        if (function_exists('as_enqueue_async_action')) {
            as_enqueue_async_action('tnxl_create_shipment_async', array('order_id' => $order_id));
        } else {
            wp_schedule_single_event(time(), 'tnxl_create_shipment_async', array('order_id' => $order_id));
        }
    }
    ...
    public function auto_create_shipment($order_id) {
        ...
        if ($order->get_meta('_tnxl_request_number')) {
            return;
        }
        ...
        if (!empty($shipments_created)) {
            ...
            $order->update_meta_data('_tnxl_all_shipments', $shipments_created);
